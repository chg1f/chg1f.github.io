...
tags: ["note", "android", "adb", "fastboot", "root", "magisk"]
---
...
#### Extract `boot.img` and `recovery.img` from `payload.bin`
...
# Use MagiskManager to modify `img` file
...
sudo fastboot continue # OR sudo fastboot reboot
```
...
# Binary files OnePlus8ProHydrogen_15.H.31_OTA_0310_all_2010291922_15e1f3321849475e/pa#yload_dumper/output/bluetooth.img and OnePlus8ProOxygen_15.E.23_OTA_023_all_2008300442_568e6/payload_dumper/output/bluetooth.img differ
